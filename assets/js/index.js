...
function main() {
     ...
     inputlFcKM.addEventListener("click", eje3ConvertidorCalcularKm);
     inputlFcM.addEventListener("click", eje3ConvertidorCalcularM);
     inputlFcFt.addEventListener("click", eje3ConvertidorCalcularFt);
     inputlFcYd.addEventListener("click", eje3ConvertidorCalcularYd);
     eje3ConvertidorCalcularKm();
     eje3ConvertidorCalcularM();
     eje3ConvertidorCalcularFt();
     eje3ConvertidorCalcularYd();

     eje3CvKmBtonLimpiar.addEventListener("click", eje3CvKmLimpiar);
     eje3CvMBtonLimpiar.addEventListener("click", eje3CvMLimpiar);
     eje3CvFtBtonLimpiar.addEventListener("click", eje3CvFtLimpiar);
     eje3CvYdBtonLimpiar.addEventListener("click", eje3CvYdLimpiar);
}
...
function eje3ConvertidorCalcularKm(){
    inputlFcKM = parseInt(document.getElementById("inputlFcKM").value);

    if (inputlFcKM == "" || inputlFcKM <= 0){
        document.getElementById("error-inputlFcKM").removeAttribute("hidden");
        document.getElementById("fcInputKmTotal").value = 0;
    } else {
        document.getElementById("error-inputlFcKM").setAttribute("hidden", "");
        document.getElementById("fcInputKmTotal").value = inputlFcKM * 1000;
    }
}

function eje3ConvertidorCalcularM(){
    inputlFcM = parseInt(document.getElementById("inputlFcM").value);

    if (inputlFcM == "" || inputlFcM <= 0){
        document.getElementById("error-inputlFcM").removeAttribute("hidden");
        document.getElementById("fcInputMTotal").value = 0;
    } else {
        document.getElementById("error-inputlFcM").setAttribute("hidden", "");
        document.getElementById("fcInputMTotal").value = inputlFcM * 100;
    }
}

function eje3ConvertidorCalcularFt(){
    inputlFcFt = parseInt(document.getElementById("inputlFcFt").value);

    if (inputlFcFt == "" || inputlFcFt <= 0){
        document.getElementById("error-inputlFcFt").removeAttribute("hidden");
        document.getElementById("fcInputFtTotal").value = 0;
    } else {
        document.getElementById("error-inputlFcFt").setAttribute("hidden", "");
        document.getElementById("fcInputFtTotal").value = inputlFcFt * 12;
    }
}

function eje3ConvertidorCalcularYd(){
    inputlFcYd = parseInt(document.getElementById("inputlFcYd").value);

    if (inputlFcYd == "" || inputlFcYd <= 0){
        document.getElementById("error-inputlFcYd").removeAttribute("hidden");
        document.getElementById("fcInputYdTotal").value = 0;
    } else {
        document.getElementById("error-inputlFcYd").setAttribute("hidden", "");
        document.getElementById("fcInputYdTotal").value = inputlFcYd * 36;
    }
}

function eje3CvKmLimpiar(){
    document.getElementById("inputlFcKM").value = 0;
    document.getElementById("fcInputKmTotal").value = 0;
}


function eje3CvMLimpiar(){
    document.getElementById("inputlFcM").value = 0;
    document.getElementById("fcInputMTotal").value = 0;
}

function eje3CvFtLimpiar(){
    document.getElementById("inputlFcFt").value = 0;
    document.getElementById("fcInputFtTotal").value = 0;
}

function eje3CvYdLimpiar(){
    document.getElementById("inputlFcYd").value = 0;
    document.getElementById("fcInputYdTotal").value = 0;
}